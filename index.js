$(function () {
    ...
    $('#js-shopping-list-form').submit(event => {
        ...
        const newListItem = '<li> <span class="shopping-item">' +
            newListInput + '</span> <div class="shopping-item-controls"> <button class="shopping-item-toggle"> <span class="button-label">check</span> </button> <button class="shopping-item-delete"> <span class="button-label">delete</span> </button> </div> </li>';
